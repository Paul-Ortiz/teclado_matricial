...
int teclado (void){
    ...
    PORTDbits.RD3 = 0;
    PORTDbits.RD0 = 1;
    _delay((unsigned long)((demora)*(4000000/4000.0)));
    if(PORTDbits.RD4 == 1){ numero = 7;}
    if(PORTDbits.RD5 == 1){ numero = 8;}
    if(PORTDbits.RD6 == 1){ numero = 9;}
    if(PORTDbits.RD7 == 1){numero = 10;}
    PORTDbits.RD0 = 0;
    PORTDbits.RD1 = 1;
    _delay((unsigned long)((demora)*(4000000/4000.0)));
    if(PORTDbits.RD4 == 1){ numero = 4;}
    if(PORTDbits.RD5 == 1){ numero = 5;}
    if(PORTDbits.RD6 == 1){ numero = 6;}
    if(PORTDbits.RD7 == 1){ numero = 11;}
    PORTDbits.RD1 = 0;
    PORTDbits.RD2 = 1;
    _delay((unsigned long)((demora)*(4000000/4000.0)));
    if(PORTDbits.RD4 == 1){ numero = 1;}
    if(PORTDbits.RD5 == 1){ numero = 2;}
    if(PORTDbits.RD6 == 1){ numero = 3;}
    if(PORTDbits.RD7 == 1){ numero = 12;}
    PORTDbits.RD2 = 0;
    PORTDbits.RD3 = 1;
    _delay((unsigned long)((demora)*(4000000/4000.0)));
    if(PORTDbits.RD4 == 1){ numero = 14;}
    if(PORTDbits.RD5 == 1){ numero = 0;}
    if(PORTDbits.RD6 == 1){ numero = 15;}
    if(PORTDbits.RD7 == 1){ numero = 13;}
    PORTDbits.RD3 = 0;
